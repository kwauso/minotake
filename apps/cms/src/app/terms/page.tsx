...
export default function TermsPage() {
  ...
  return (
    <>
      <HelmetProvider>
      <Helmet>
        <title>利用規約 | ぐんま山育DAO</title>
        <meta 
          name="description" 
          content="株式会社ぐんま山育DAOの利用規約についてご確認いただけます。サービスの利用条件、禁止事項、免責事項などについて定めています。" 
        />
      </Helmet>
          ...
          <div className="space-y-8">
            ...
            <section>
              ...
              <ul className="list-disc pl-6 mt-4 text-[15px] leading-8 text-black/80">
                ...
                <li>当社は、アカウントの漏洩、不正使用等による損害について、一切の責任を負いません。</li>
              </ul>
            </section>
            ...
            <section>
              ...
              <ul className="list-disc pl-6 mt-4 text-[15px] leading-8 text-black/80">
                ...
                <li>当社は、本サービスの内容変更、中断、終了によって生じたいかなる損害についても、一切の責任を負いません。</li>
                <li>当社は、ユーザーが本サービスの利用に関して被った損害について、一切の責任を負いません。</li>
              </ul>
            </section>
