...
const faqItems: FAQItem[] = [
  ...
  },
  {
    ...
    answer: '法人の方も参加可能です。出資金額は個人と異なりますので、詳細は説明会にてご確認ください。'
  },
  {
    question: '参加時に証券口座やウォレットなど準備は必要ですか？',
    answer: '特別な準備は必要ありません。通常の銀行口座をお持ちであれば参加可能です。'
  },
  {
    question: '参加には勤め先の会社に申請など必要ですか？',
    answer: '一般的な投資として参加される場合は特別な申請は不要です。ただし、貢献活動を行う場合は、所属企業の副業規定に従ってご判断ください。'
  },
  {
    question: 'メンバーとして貢献活動を実施する場合、副業に該当しますか？',
    answer: '活動内容によって副業に該当する場合があります。所属企業の副業規定をご確認の上、必要に応じて申請をお願いいたします。'
  }
];
