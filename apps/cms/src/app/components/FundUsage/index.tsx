...
const fundUsages = [
  {
    category: '外注費',
    title: '土地の購入費用',
    description: '土地の購入を合同会社ちもりが行い、\n土地のオーナー権を群馬ピークスプロジェクトに委譲する形となります。',
    amount: 2000
  },
  {
    category: '外注費',
    ...
    <section className="py-32">
      <div className="flex flex-col gap-4 max-w-[920px] mx-auto">
        ...
        <p className="text-[10px] leading-[18px] opacity-50 font-genei-gothic">
          ※群馬ピークスプロジェクトが土地を購入をする訳ではありません。製造にかかる費用の一部として発生する経費の例です。ワインの製造にかかる全工程(ぶどうの苗木や、収穫等を含む)は、業務委託契約を合同会社ちもりと行い、発注を行います。段階的に企画フェーズ・栽培フェーズ・商品化フェーズに分けて発注を行います。
        </p>
      </div>
    </section>
  );
